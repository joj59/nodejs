...
var showAlert = function showAlert(type, mess) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(mess, "</div>");
...
var stripe = Stripe('pk_test_51H2yx5FqwHnGCNOb3rHcMiLEOrDHaIuPg6D92OYKQGlhf1Y5jL34bsWLPQNLd4bKsGZROyfOC9LSlbNruF48Bk4600WSbKEe7I');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " was successfully updated"));
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoiam9qaWpvc2VwaDA3IiwiYSI6ImNrY2J6ZG92ajJhNzYycnRpeWp0NW8wY2UifQ.qywxy-rnbmLwE1ijRLlshQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/jojijoseph07/ckcbzs8mm0k8k1ipi706s94fe',
    scrollZoom: false //   centre: [-118.25246, 34.025852],
...
var userDetails = document.querySelector('.form-user-data');
var passwordUpdate = document.querySelector('.form-user-password');
...
if (userDetails) {
  userDetails.addEventListener('submit', function (e) {
    e.preventDefault();
